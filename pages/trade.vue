...
<template>
  ...
  <div class="min-h-screen pb-20 md:pb-0">
    ...
    <div class="container mx-auto max-w-7xl px-2 sm:px-4 lg:px-6 flex-grow main-content">
      ...
      <div class="bg-gray-900 rounded-lg shadow-xl overflow-hidden mb-4">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-0.5">
          <!-- Gráfico - 2/3 ancho en desktop con mejor altura -->
          <div class="col-span-full lg:col-span-2 bg-gray-800 rounded-lg overflow-hidden">
            <div class="w-full h-[400px] sm:h-[450px] lg:h-[500px]">
              <!-- Filtros de Intervalo de Tiempo con mejor diseño -->
              <div class="p-2 border-b border-gray-700 flex space-x-2 overflow-x-auto scrollbar-hide bg-gray-800/80 backdrop-blur-sm sticky top-0 z-10">
                <button @click="changeTimeInterval('1h')"
                  :class="{ 'bg-yellow-500 text-gray-900': timeInterval === '1h', 'bg-gray-700 text-gray-300 hover:bg-gray-600': timeInterval !== '1h' }"
                ...
                <button @click="changeTimeInterval('4h')"
                  :class="{ 'bg-yellow-500 text-gray-900': timeInterval === '4h', 'bg-gray-700 text-gray-300 hover:bg-gray-600': timeInterval !== '4h' }"
                ...
                <button @click="changeTimeInterval('1d')"
                  :class="{ 'bg-yellow-500 text-gray-900': timeInterval === '1d', 'bg-gray-700 text-gray-300 hover:bg-gray-600': timeInterval !== '1d' }"
                ...
                <button @click="changeTimeInterval('1w')"
                  :class="{ 'bg-yellow-500 text-gray-900': timeInterval === '1w', 'bg-gray-700 text-gray-300 hover:bg-gray-600': timeInterval !== '1w' }"
                ...
                <button @click="changeTimeInterval('1m')"
                  :class="{ 'bg-yellow-500 text-gray-900': timeInterval === '1m', 'bg-gray-700 text-gray-300 hover:bg-gray-600': timeInterval !== '1m' }"
          ...
          <div class="col-span-full lg:col-span-1 bg-gray-800 rounded-lg overflow-hidden shadow-lg flex flex-col h-[400px] sm:h-[450px] lg:h-[500px]">
            <!-- Pestañas Libro/Operaciones -->
            <div class="px-3 py-2 border-b border-gray-700 bg-gray-800/90 backdrop-blur-sm sticky top-0 z-10">
              <div class="flex bg-gray-700/80 rounded-lg p-0.5">
                <button @click="activeTab = 'orderbook'"
                  :class="activeTab === 'orderbook' ? 'bg-yellow-500 text-gray-900' : 'text-gray-300 hover:text-white'"
                  class="flex-1 px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200">
                  Libro de Órdenes
                </button>
                <button @click="activeTab = 'trades'"
                  :class="activeTab === 'trades' ? 'bg-yellow-500 text-gray-900' : 'text-gray-300 hover:text-white'"
                  class="flex-1 px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200">
                  Operaciones
                </button>
              </div>
